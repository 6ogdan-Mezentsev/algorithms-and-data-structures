...
if __name__ == "__main__":
    ...
    print(f"Стек пустой(True), непустой(False): {stack.isEmpty()}")
    print("Добавляем в стек элемент '1'")
    print("Добавляем в стек элемент '2'")
    print("Добавляем в стек элемент '3'")
    stack.push(1)
    stack.push(2)
    stack.push(3)
    print(f"Текущий стек: {stack.display_stack()}")
    print(f"Из стека удаляем элемент '3'")
    stack.pop()
    print(f"Текущий стек: {stack.display_stack()}")
    print(f"Из стека удаляем элемент '2'")
    stack.pop()
    print(f"Текущий стек: {stack.display_stack()}")
    print()